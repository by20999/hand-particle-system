...
- 3D 粒子模型：粒子组成带有厚度的 3D 爱心，也可以切换成全方位 3D 花朵、土星、待爆烟花、钻戒、生日蛋糕、气球、自定义文字、图片/Logo 点云和 GLB 模型表面点云。
...
- 模型缩略图选择：主面板保留爱心、花朵、土星、生日蛋糕、烟花、文字六个常用模型，戒指、气球、图片、3D 和预留入口收进“更多模型”，切换时粒子会先散开再重组。
